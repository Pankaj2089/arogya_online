              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Designation Name" value="{{ $rowData->name ?? '' }}" name="name" id="name">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/admin/edit-designation/'.$row_id)}}";
    let returnURL = "{{url('/admin/designations')}}";
</script>
<script src="{{ asset('public/admin/js/pages/designations/edit-page.js') }}"></script>
@endsection
