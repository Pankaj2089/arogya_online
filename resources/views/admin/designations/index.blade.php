    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Designations Management</h3>
                <p class="text-subtitle text-muted">Designations list.</p>
            </div>
        ...
        <div class="card">
           <!--begin::Card body-->
            <div class="card-body">
                ...
                <a href="{{url('/admin/add-designation')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Designation</a>
            </div>
            <!--end::Card body-->
        </div>
    </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/designations_paginate') }}",
