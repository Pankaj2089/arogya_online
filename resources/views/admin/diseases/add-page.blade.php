              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Disease Name" value="" name="name" id="name">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/admin/add-disease')}}";
    let returnURL = "{{url('/admin/diseases')}}";
</script>
<script src="{{ asset('public/admin/js/pages/diseases/add-page.js') }}"></script>
@endsection
