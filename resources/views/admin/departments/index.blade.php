    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Departments list.</p>
            </div>
        ...
        <div class="card">
           <!--begin::Card body-->
            <div class="card-body">
                ...
                <a href="{{url('/admin/add-department')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Department</a>
            </div>
            <!--end::Card body-->
        </div>
    </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/departments_paginate') }}",
