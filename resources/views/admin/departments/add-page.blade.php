              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Department Name" value="" name="name" id="name">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/admin/add-department')}}";
    let returnURL = "{{url('/admin/departments')}}";
</script>
<script src="{{ asset('public/admin/js/pages/departments/add-page.js') }}"></script>
@endsection
