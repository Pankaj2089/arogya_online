              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Department Name" value="{{ $rowData->name ?? '' }}" name="name" id="name">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/admin/edit-department/'.$row_id)}}";
    let returnURL = "{{url('/admin/departments')}}";
</script>
<script src="{{ asset('public/admin/js/pages/departments/edit-page.js') }}"></script>
@endsection
