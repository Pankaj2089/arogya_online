      ...
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Financial Year</li>
          </ol>
        </nav>
      </div>
    </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control numberonly" min="0" step="1" placeholder="Enter OPD Number" value="0" name="opd_number" id="opd_number">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script>
    ...
    let saveDataURL = "{{url('/admin/add-financial-year')}}";
    let returnURL = "{{url('/admin/financial-years')}}";
</script>
<script src="{{ asset('public/admin/js/pages/financial-years/add-page.js') }}"></script>
@endsection
