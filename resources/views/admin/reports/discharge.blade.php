...
<div class="page-heading">
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        ...
        <p class="text-subtitle text-muted">Search for Discharge across OPD records.</p>
      </div>
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Discharge Reports</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <section class="section">
    ...
    <div class="card">
      <div class="card-body">
        <form id="dischargeReportsForm" method="get" action="{{ url('/admin/discharge-reports') }}">
    ...
    @if($records->count() > 0)
    <div class="mb-2">
      <a href="{{ url('/admin/discharge-reports-export') }}?from_date={{ urlencode(request('from_date', '')) }}" class="btn btn-success btn-sm">
            ...
            <tbody>
              @if($records->count() > 0)
                ...
                <tr>
                  ...
                  <td>{{ $row->opd->department ? $row->opd->department->name : '—' }}</td>
